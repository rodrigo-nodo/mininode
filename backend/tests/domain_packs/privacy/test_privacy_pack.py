...
def test_optional_visible_evidence_is_additive_to_priority_contract():
    result = {
        "control_code": "PRV-104",
        "result": "not_detected",
        "confidence": "high",
        "source_url": "https://example.com/contact",
        "evidence_summary": "Formulario que solicita correo electrónico.",
    }

    priority = prioritize_findings([result])[0]

    assert priority == {
        "control_code": "PRV-104",
        "name": EXPECTED["PRV-104"][0],
        "priority": "Alta",
        "finding": load_controls()[3]["criteria"]["not_detected"],
        "recommendation": load_controls()[3]["base_recommendation"],
        "source_url": "https://example.com/contact",
        "evidence_summary": "Formulario que solicita correo electrónico.",
    }

...
CODES = ["PRV-001", "PRV-002", "PRV-003", "PRV-005", "PRV-006", "PRV-007", "PRV-008", "PRV-010", "PRV-011", "PRV-101", "PRV-104", "PRV-201", "PRV-301", "PRV-501"]
...
def test_full_contract_runs_complete_privacy_pipeline():
    ...
    assert len(result["controls"]) == 14
    assert result["controls"][1]["result"] == "detected"
    assert result["controls"][10]["result"] == "detected"
...
def test_technical_failure_is_unscored_not_artificially_penalized():
    ...
    assert result["applicable_controls"] == 13

...
CODES = ["PRV-001", "PRV-002", "PRV-003", "PRV-005", "PRV-006", "PRV-007", "PRV-008", "PRV-011", "PRV-101", "PRV-104", "PRV-201", "PRV-301", "PRV-501"]
...
def complete_contract():
    ...
    return EvidenceContract(
        ...
        [PageEvidence("https://example.com/", 200, "Inicio", "text/html"), PageEvidence("https://example.com/privacy", 200, "Privacy", "text/html", visible_text="Example recopila nombre y correo para responder consultas. Para ejercer sus derechos de acceso y rectificación escriba al correo de privacidad.")],
...
def test_full_contract_runs_complete_privacy_pipeline():
    ...
    assert result["controls"][9]["result"] == "detected"
...
def test_technical_failure_is_unscored_not_artificially_penalized():
    ...
    assert result["applicable_controls"] == 12

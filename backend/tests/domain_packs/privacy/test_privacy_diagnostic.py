...
CODES = ["PRV-001", "PRV-002", "PRV-003", "PRV-005", "PRV-101", "PRV-104", "PRV-201", "PRV-301", "PRV-501"]
...
def test_full_contract_runs_complete_privacy_pipeline():
    ...
    assert result["controls"][5]["result"] == "detected"
...
def test_technical_failure_is_unscored_not_artificially_penalized():
    ...
    assert result["applicable_controls"] == 8

...
def test_every_action_is_actionable_and_reachable_through_active_pipeline():
    ...
    scenarios = {
        ...
        "PRV-005": [({"responsible_identification": "ambiguous"}, {"PRV-003": "detected"}), ({"responsible_identification": "none"}, {"PRV-003": "detected"})],
        "PRV-006": [({"rights_channel": "generic"}, {"PRV-003": "detected"}), ({"rights_channel": "none"}, {"PRV-003": "detected"})],
        "PRV-007": [({"generic_personal_data": True}, {"PRV-003": "detected"}), ({}, {"PRV-003": "detected"})],
        "PRV-008": [({"generic_data_use": True}, {"PRV-003": "detected"}), ({}, {"PRV-003": "detected"})],
        "PRV-011": [({"holder_rights": ["acceso"]}, {"PRV-003": "detected"}), ({}, {"PRV-003": "detected"})],
        "PRV-104": [

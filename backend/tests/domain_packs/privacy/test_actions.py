...
def test_every_action_is_actionable_and_reachable_through_active_pipeline():
    ...
    scenarios = {
        ...
        "PRV-005": [({"controller_identification": "generic"}, {"PRV-003": "detected"}), ({"controller_identification": "none"}, {"PRV-003": "detected"})],
        "PRV-006": [({"rights_channel": "generic"}, {"PRV-003": "detected"}), ({"rights_channel": "none"}, {"PRV-003": "detected"})],
        "PRV-007": [({"data_categories": "generic"}, {"PRV-003": "detected"}), ({"data_categories": "none"}, {"PRV-003": "detected"})],
        "PRV-008": [({"processing_purposes": "generic"}, {"PRV-003": "detected"}), ({"processing_purposes": "none"}, {"PRV-003": "detected"})],
        "PRV-011": [({"holder_rights": "limited"}, {"PRV-003": "detected"}), ({"holder_rights": "none"}, {"PRV-003": "detected"})],
        "PRV-104": [

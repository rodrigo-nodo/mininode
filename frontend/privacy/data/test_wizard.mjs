...
const singleReview = reviewMarkup([{type: 'review', title: 'Uno', description: 'Detalle', activity_type: 'sales'}], catalog);
assert.match(singleReview, /Encontramos 1 aspecto en esta primera revisión\./);

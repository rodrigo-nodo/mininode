...
class PrivacyResultStaticTests(unittest.TestCase):
    ...
    def test_priorities_and_commercial_paths_are_preserved(self):
        ...
        self.assertIn("1 mes", HTML)
        self.assertNotIn("pago único", HTML)
        self.assertIn("Mantén tu Privacy Web activo por $9.900 al mes.", HTML)
        ...
        self.assertIn("Disponible durante 30 días desde la compra.", HTML)
        self.assertIn("Activar Privacy Web por 1 mes", HTML)
        self.assertIn("Sin renovación automática por ahora.", HTML)
    ...
    def test_app_script_is_cache_busted_with_the_result_markup(self):
        self.assertIn('<script src="app.js?v=113" defer></script>', HTML)

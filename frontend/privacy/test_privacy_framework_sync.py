...
class PrivacyFrameworkSyncTests(unittest.TestCase):
    def test_runtime_matrix_matches_backend_framework_0_6(self):
        ...
        self.assertEqual(CONTROLS["version"], "0.6")
    ...
    def test_sync_runs_after_app_and_updates_visible_scope(self):
        self.assertIn('<script src="framework-v0.6.js?v=1" defer></script>', HTML)
        self.assertLess(
            HTML.index('<script src="app.js?v=113" defer></script>'),
            HTML.index('<script src="framework-v0.6.js?v=1" defer></script>'),
        )
